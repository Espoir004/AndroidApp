...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_PLAN_TEMP        = "temperature";
    private static final String COLUMN_PLAN_HOLIDAY     = "holiday";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_PLANS_TABLE = "CREATE TABLE " + TABLE_PLANS + "("
                ...
                + COLUMN_PLAN_TEMP + " TEXT,"
                + COLUMN_PLAN_HOLIDAY + " TEXT" + ")";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // 平滑升级：只加列
        db.execSQL("ALTER TABLE " + TABLE_PLANS + " ADD COLUMN " + COLUMN_PLAN_TEMP + " TEXT DEFAULT ''");
        db.execSQL("ALTER TABLE " + TABLE_PLANS + " ADD COLUMN " + COLUMN_PLAN_HOLIDAY + " TEXT DEFAULT ''");
    }
    ...
    public void addPlan(Plan plan) {
        ...
        values.put(COLUMN_PLAN_TEMP, plan.getTemperature());
        values.put(COLUMN_PLAN_HOLIDAY, plan.getHoliday());
    ...
    public List<Plan> getAllPlans(int userId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                plan.setTemperature(cursor.getString(5));
                plan.setHoliday(cursor.getString(6));
                planList.add(plan);
